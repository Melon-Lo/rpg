  ...
  const handleSave = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        const progressData = {
          characterStats: { name: currentName, classTitle: currentClassTitle, level: currentLevel, HP, maxHP, MP, maxMP, ATK, DEF, MATK, MDEF, SPD, exp, expToNextLevel, skills, equipments, equipmentsStats, totalStats },
